...
{
    public class PropertyModel: IChartDataSource
    {
        public delegate void OnSuccess();

        public delegate void OnError(string msg);

        public enum PropertyPresentationMode
        {
            History,
            Continuous
        ...
        public void GetThingObjectAsync(string key, BaseModel.OnSuccess onSuccess, BaseModel.OnError onError)
        {
            Task.Run(async () =>
                {
                    try
