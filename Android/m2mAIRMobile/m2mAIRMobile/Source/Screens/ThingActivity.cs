...
namespace Android.Source.Screens
{
    ...
    public class ThingActivity : BaseActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            properties.Click += (object sender, EventArgs e) =>
            {
                OnProperties();
            };
            Button locationHistory = FindViewById<Button>(m2m.Android.Resource.Id.locationHistory);
            locationHistory.Click += (object sender, EventArgs e) =>
            {
                OnLocationHistoryClicked();
            };

            viewModel = new ThingModel();
