		...
		com.nulana.NChart.NChartSeriesDataSource
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DifferentCharts.BubbleChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BubbleChartController.class, __md_methods);
	}


	public BubbleChartController () throws java.lang.Throwable
	{
		super ();
		if (getClass () == BubbleChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.BubbleChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public BubbleChartController (com.nulana.NChart.NChartView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == BubbleChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.BubbleChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "NChart3D_Android.NChartView, NChart3D, Version=1.14.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
