		...
		com.nulana.NChart.NChartSeriesDataSource
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DifferentCharts.BarChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BarChartController.class, __md_methods);
	}


	public BarChartController () throws java.lang.Throwable
	{
		super ();
		if (getClass () == BarChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.BarChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public BarChartController (com.nulana.NChart.NChartView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == BarChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.BarChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "NChart3D_Android.NChartView, NChart3D, Version=1.14.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
