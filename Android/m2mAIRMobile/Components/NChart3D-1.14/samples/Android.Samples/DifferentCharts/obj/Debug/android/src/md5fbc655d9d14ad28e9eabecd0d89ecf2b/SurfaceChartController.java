...
public class SurfaceChartController
		...
		com.nulana.NChart.NChartSeriesDataSource
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DifferentCharts.SurfaceChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SurfaceChartController.class, __md_methods);
	}


	public SurfaceChartController () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SurfaceChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.SurfaceChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public SurfaceChartController (com.nulana.NChart.NChartView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == SurfaceChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.SurfaceChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "NChart3D_Android.NChartView, NChart3D, Version=1.14.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
