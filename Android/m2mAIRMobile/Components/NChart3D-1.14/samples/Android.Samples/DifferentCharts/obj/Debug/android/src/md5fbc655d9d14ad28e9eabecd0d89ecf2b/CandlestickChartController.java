		...
		com.nulana.NChart.NChartSeriesDataSource
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DifferentCharts.CandlestickChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CandlestickChartController.class, __md_methods);
	}


	public CandlestickChartController () throws java.lang.Throwable
	{
		super ();
		if (getClass () == CandlestickChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.CandlestickChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public CandlestickChartController (com.nulana.NChart.NChartView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == CandlestickChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.CandlestickChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "NChart3D_Android.NChartView, NChart3D, Version=1.14.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
