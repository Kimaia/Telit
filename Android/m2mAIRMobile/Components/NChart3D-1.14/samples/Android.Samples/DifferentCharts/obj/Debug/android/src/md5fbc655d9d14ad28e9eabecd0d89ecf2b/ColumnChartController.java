		...
		com.nulana.NChart.NChartSeriesDataSource
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DifferentCharts.ColumnChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ColumnChartController.class, __md_methods);
	}


	public ColumnChartController () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ColumnChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.ColumnChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public ColumnChartController (com.nulana.NChart.NChartView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == ColumnChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.ColumnChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "NChart3D_Android.NChartView, NChart3D, Version=1.14.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
