		...
		com.nulana.NChart.NChartSeriesDataSource
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DifferentCharts.RadarChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", RadarChartController.class, __md_methods);
	}


	public RadarChartController () throws java.lang.Throwable
	{
		super ();
		if (getClass () == RadarChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.RadarChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public RadarChartController (com.nulana.NChart.NChartView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == RadarChartController.class)
			mono.android.TypeManager.Activate ("DifferentCharts.RadarChartController, DifferentCharts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "NChart3D_Android.NChartView, NChart3D, Version=1.14.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
